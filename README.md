...
- 📉 **70% Infrastructure Reduction**: Reduced 200 AWS Lambda functions to 60
- ⚡ **96% Performance Improvement**: Optimized queries from 2 days to 2 hours  
- 🔧 **47% Technical Debt Reduction**: Reduced 160 .NET projects to 85
- 🚀 **40% Delivery Speed Increase**: Through AI-assisted development
- 👥 **3M+ Users Impacted**: Built solutions serving millions
...
![Angular](https://img.shields.io/badge/Angular-Expert-DD0031?logo=angular)
![Vue.js](https://img.shields.io/badge/Vue.js-Proficient-4FC08D?logo=vue.js)

### Backend
![Node.js](https://img.shields.io/badge/Node.js-Expert-339933?logo=node.js)
![C#](https://img.shields.io/badge/C%23-Expert-239120?logo=c-sharp)
![.NET Core](https://img.shields.io/badge/.NET%20Core-Expert-512BD4?logo=.net)
![NestJS](https://img.shields.io/badge/NestJS-Proficient-E0234E?logo=nestjs)

### Cloud & Infrastructure
![AWS Lambda](https://img.shields.io/badge/AWS%20Lambda-Expert-FF9900?logo=aws-lambda)
![CloudFront](https://img.shields.io/badge/CloudFront-Expert-FF9900?logo=amazon-aws)
![DynamoDB](https://img.shields.io/badge/DynamoDB-Expert-4053D6?logo=amazon-dynamodb)
![Azure DevOps](https://img.shields.io/badge/Azure%20DevOps-Proficient-0078D4?logo=azure-devops)

### Database
![PostgreSQL](https://img.shields.io/badge/PostgreSQL-Expert-336791?logo=postgresql)
![SQL Server](https://img.shields.io/badge/SQL%20Server-Expert-CC2927?logo=microsoft-sql-server)

### AI Tools
![Cursor](https://img.shields.io/badge/Cursor-Expert-000000?logo=cursor)
![ChatGPT](https://img.shields.io/badge/ChatGPT-Expert-412991?logo=openai)
